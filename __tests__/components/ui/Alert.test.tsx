...
function testAlertRendersMessage() {
...
function testAlertSuccessStyles() {
...
describe('Alert Component', () => {
    testAlertRendersMessage()
    testAlertSuccessStyles()
    testAlertErrorStyles()
})
